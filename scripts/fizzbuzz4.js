...
function fizzbuzz4() {
	...
	for (i; i<total+1; i++) {
			if (check(i, num1)){
				sampleText = "class='num3'>&nbsp;&nbsp;&nbsp;" + word1 + "</li>";
				if (check(i, num2)) {
						sampleText = "class='num3-5'>&nbsp;&nbsp;&nbsp;" + word1 + " " + word2 + "</li>";
						if (check(i, num3)) {
							sampleText = "class='allNumber'>&nbsp;&nbsp;&nbsp;" + word1 + " " + word2 + " " + word3 + "</li>";
						}
				} else {
					if (check(i, num3)) {
						sampleText= "class='num3-7'>&nbsp;&nbsp;&nbsp;" + word1 + " " + word3 + "</li>";
					} 					
				}
			} else {
				if (check(i, num2)) {
					sampleText= "class='num5'>&nbsp;&nbsp;&nbsp;" + word2 + "</li>";
					if (check(i, num3)) {
						sampleText= "class='num5-7'>&nbsp;&nbsp;&nbsp;" + word2 + " " + word3 + "</li>";
					}
				} else {
					if (check(i, num3)) {
						sampleText= "class='num7'>&nbsp;&nbsp;&nbsp;" + word3 + "</li>";
					} else {
						sampleText = ">&nbsp;&nbsp;&nbsp;" + word4 + "</li>";
					} 						
				}
